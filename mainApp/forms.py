...
class RegistrationForm(FlaskForm):
    ...
    teamMember_1 = StringField('Member 1')
    teamMember_2 = StringField('Member 2')
    themesS = SelectField('Theme', choices=[('None', 'Select'), ('smart', 'Smart City/ Swachh Bharat'), ('sustain', 'Sustainable Development'), ('health', 'HealthCare and Biomedical Services'), ('security', "Security and Surveillance"), ('innovate', 'Student Innovation'), ('COVID', 'COVID-19 and Quarantine')])
    themesE = SelectField('Theme',
